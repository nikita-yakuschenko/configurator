  ...
  lot: [
    {
      ...
      fields: [
        {
          id: "site-preparation",
          label: "Подготовка участка",
          options: [
            {
              id: "tree-cutting",
              label: "Спил деревьев",
              priceDelta: 20000,
              description: "От 20 000 руб. в зависимости от объема работ",
            },
            {
              id: "site-leveling",
              label: "Планировка участка",
              priceDelta: 30000,
              description: "От 30 000 руб. в зависимости от геометрии участка",
            },
            {
              id: "variant-3",
              label: "Вариант 3",
              priceDelta: 0,
              description: "Резервный вариант (уточняется)",
            },
          ],
        },
        {
          ...
          options: [
            {
              id: "remote",
              label: "Удалённая консультация",
              priceDelta: 0,
              description: "Первичная оценка по документам и фото",
              recommended: true,
            },
            {
              id: "site-survey",
              label: "Обследование участка",
              priceDelta: 20000,
              description: "От 20 000 руб. в зависимости от объема обследования",
            },
            {
              id: "access-road-survey",
              label: "Проверка подъездных путей",
              priceDelta: 30000,
              description: "Проверка состояния и доступности подъездных путей",
            },
          ],
        },
      ],
